    ...
    <footer className="max-container">
      ...
      gap-20 flex-wrap max-lg:flex-col" >
        ...
        flex flex-col items-start">
          ...
          leading-7 font-montserrat text-white-400 sm:max-w-sm '> Get shoes ready</p>
          <div
          className='flex items-center gap-5 mt-8'>
            {socialMedia.map((icon) => (
              <div className='flex justify-center items-center
              w-12 h-12 bg-coral-red rounded-full'>
                <img
                src={icon.src}
                alt={icon.alt}
                width={24}
      ...
      text-white-400 mt-24 max-sm:flex-col max-sm:items-center'>
        <div className='flex
        justify-start items-center gap-2 font-montserrat
        cursor-pointer'>
          <img
          src={copyrightSign}
          alt='copyright'
